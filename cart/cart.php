...
<body>
    ...
    <div class="container" style="width: 65%">
        <h2>Order Cart</h2>
        <?php
            $query = "SELECT * FROM price_list   ORDER BY f_id ASC ";
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="Cart.php?action=add&id=<?php echo $row["f_id"]; ?>">
                            ...
                            <div class="product">
                                ...
                                <h5 class="text-danger"><?php echo $row["wash_price"]; ?></h5>
                               

                                <input type="text" name="quantity" class="form-control" value="1">
                                <input type="hidden" name="hidden_name" value="<?php echo $row["name"]; ?>">
                                <input type="hidden" name="hidden_price" value="<?php echo $row["wash_price"]; ?>">
    ...
    <div style="margin-left:30%" class="div">
    <form action="insert_order.php" target="_blank" id="orderFORM" method="GET">
                ...
                <input type="hidden" id="payment" name="billAmount" value="<?php echo $total; ?>">
